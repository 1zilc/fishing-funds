...
export async function GetLiveList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_zhiboall_ajaxResult_70_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetListedList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_103_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetGoodsList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_106_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetExchangeList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_107_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetBondList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_108_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetFundList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_109_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetChinaList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_118_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetUsaList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_119_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetEuList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_120_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetUkList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_121_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
...
export async function GetJpList() {
  try {
    const { body: script } = await request(
      `https://newsapi.eastmoney.com/kuaixun/v1/getlist_122_ajaxResult_50_1_.html`,
      {
        responseType: 'text',
        searchParams: {
          _: Date.now(),
