...
const FundStatisticsContent = React.lazy(() => import('@/components/Home/FundList/FundStatisticsContent'));
...
const FundRankingContent = React.lazy(() => import('@/components/Home/FundList/FundRankingContent'));
const StockRankingContent = React.lazy(() => import('@/components/Home/StockList/StockRankingContent'));
const CoinRankingContent = React.lazy(() => import('@/components/Home/CoinList/CoinRankingContent'));
const EconomicCalendarContent = React.lazy(() => import('@/components/Home/StockList/EconomicCalendarContent'));
