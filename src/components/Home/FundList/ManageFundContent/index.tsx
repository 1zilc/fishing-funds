...
const ManageFundContent: React.FC<ManageFundContentProps> = (props) => {
  ...
  const { done: updateFundSeetingDone } = useSyncFixFundSetting();
  ...
  useEffect(updateSortFundConfig, [updateFundSeetingDone]);
